	      	...
	      	<c:forEach var="tempProduct" items="${products}"> 
		        ...
		        <div class="col">
		          <div class="card shadow-sm">
		            ...
		            <div class="card-body">
		            <h3>${tempProduct.productName }</h3>
		              <p class="card-text">${tempProduct.subDescription }</p>
		              <div class="d-flex justify-content-between align-items-center">
		                <div class="btn-group">
		                  <button type="button" class="btn btn-sm btn-outline-secondary">View</button>
		                </div>
		                <small class="text-muted">Price: <fmt:formatNumber value="${tempProduct.price }" type="number" currencySymbol=""/> VND</small>
		              </div>
		            </div>
		          </div>
		        </div>
